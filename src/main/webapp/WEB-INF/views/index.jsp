...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<spring:url value='resources/vendor/simple-line-icons/css/simple-line-icons.css'/>">
    <link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Catamaran:100,200,300,400,500,600,700,800,900" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Muli" rel="stylesheet">

    <!-- Plugin CSS -->
    <link rel="stylesheet" href="<spring:url value='resources/device-mockups/device-mockups.min.css'/>">
  ...
  <body id="page-top">
              ...
              <div class="device-mockup iphone6_plus portrait white">
                <div class="device">
                  <div class="screen">
                    ...
                    <img src="<spring:url value='resources/img/demo-screen-1.jpg'/>" class="img-fluid" alt="">
                  </div>
                  <div class="button">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 mx-auto">
            ...
            <div class="badges">
              <a class="badge-link" href="#"><img src="<spring:url value='resources/img/google-play-badge.svg'/>" alt=""></a>
              <a class="badge-link" href="#"><img src="<spring:url value='resources/img/app-store-badge.svg'/>" alt=""></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <script src="<spring:url value='resources/js/new-age.min.js'/>"></script>
